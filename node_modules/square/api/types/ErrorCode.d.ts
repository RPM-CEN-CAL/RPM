...
export declare const ErrorCode: {
    ...
    readonly AmountTooLow: "AMOUNT_TOO_LOW";
    ...
    readonly PartialPaymentDelayCaptureNotSupported: "PARTIAL_PAYMENT_DELAY_CAPTURE_NOT_SUPPORTED";
    ...
    readonly PlaidErrorInvalidAccessToken: "PLAID_ERROR_INVALID_ACCESS_TOKEN";
    readonly PlaidErrorInvalidAccountId: "PLAID_ERROR_INVALID_ACCOUNT_ID";
    readonly PlaidErrorNoAccounts: "PLAID_ERROR_NO_ACCOUNTS";
    readonly PlaidErrorItemNotFound: "PLAID_ERROR_ITEM_NOT_FOUND";
    readonly PlaidErrorInsufficientCredentials: "PLAID_ERROR_INSUFFICIENT_CREDENTIALS";
    readonly PlaidErrorItemNotSupported: "PLAID_ERROR_ITEM_NOT_SUPPORTED";
    readonly PlaidErrorProductNotReady: "PLAID_ERROR_PRODUCT_NOT_READY";
    readonly PaymentSourceNotEnabledForTarget: "PAYMENT_SOURCE_NOT_ENABLED_FOR_TARGET";
    ...
    readonly CartIneligibleForEbt: "CART_INELIGIBLE_FOR_EBT";
